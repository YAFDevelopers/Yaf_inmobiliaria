...
(
	...
	`Contrasena_Agentes` VARCHAR(50) NOT NULL,
...
(
	...
	`FechaRegistro_Citas` TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
(
	...
	`Contrasena_Clientes` VARCHAR(50) NOT NULL,
	`NumeroTelefono_Clientes` VARCHAR(50) NOT NULL,
	`Estado_Clientes` VARCHAR(50) NOT NULL,
	`FechaRegistro_Clientes` TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
(
	...
	`FechaRegistro_Inmuebles` TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
	CONSTRAINT `PK_Table1` PRIMARY KEY (`IdInmueble_Inmuebles` ASC)
)
...
ALTER TABLE `Citas` 
 ADD CONSTRAINT `FK_Citas_Agente`
	FOREIGN KEY (`IdAgente_Citas`) REFERENCES `Agentes` (`IdAgente_Agentes`) ON DELETE Restrict ON UPDATE Cascade
;
...
ALTER TABLE `Citas` 
 ADD CONSTRAINT `FK_Citas_Inmuebles`
	FOREIGN KEY (`IdInmueble_Citas`) REFERENCES `Inmuebles` (`IdInmueble_Inmuebles`) ON DELETE Restrict ON UPDATE Cascade
;
...
ALTER TABLE `Inmuebles` 
 ADD CONSTRAINT `FK_Inmuebles_TipoInmuebles`
...
INSERT INTO `Clientes` (`IdCliente_Clientes`, `IdTipoDocumento_Clientes`, `NumeroDocuemto_Clientes`, `PrimerNombre_Clientes`, `SegundoNombre_Clientes`, `PrimerApellido_Clientes`, `SegundoApellido_Clientes`, `FechaNacimiento_Clientes`, `Correo_Clientes`, `Contrasena_Clientes` , `NumeroTelefono_Clientes`, `Estado_Clientes`, `FechaRegistro_Clientes`) VALUES (NULL, '1', '173481758732', 'Jorge', NULL, 'Camacho', NULL, '1970-01-16', 'camacho@gmail.com','1234', '3456789012', 'ACTIVO', NULL);
INSERT INTO `Clientes` (`IdCliente_Clientes`, `IdTipoDocumento_Clientes`, `NumeroDocuemto_Clientes`, `PrimerNombre_Clientes`, `SegundoNombre_Clientes`, `PrimerApellido_Clientes`, `SegundoApellido_Clientes`, `FechaNacimiento_Clientes`, `Correo_Clientes`, `Contrasena_Clientes` , `NumeroTelefono_Clientes`, `Estado_Clientes`, `FechaRegistro_Clientes`) VALUES (NULL, '2', '65675475667', 'Jane', NULL, 'Smith', NULL, '1990-04-09', 'jane@gmail.com','1234', '3210987654', 'ACTIVO', NULL);
INSERT INTO `Clientes` (`IdCliente_Clientes`, `IdTipoDocumento_Clientes`, `NumeroDocuemto_Clientes`, `PrimerNombre_Clientes`, `SegundoNombre_Clientes`, `PrimerApellido_Clientes`, `SegundoApellido_Clientes`, `FechaNacimiento_Clientes`, `Correo_Clientes`, `Contrasena_Clientes` , `NumeroTelefono_Clientes`, `Estado_Clientes`, `FechaRegistro_Clientes`) VALUES (NULL, '3', '21325647656', 'Luis', NULL, 'Perez', NULL, '1989-03-09', 'luis@gmail.com','1234', '3102948576', 'ACTIVO', NULL);

INSERT INTO `Agentes` (`IdAgente_Agentes`, `IdTipoDocumento_Agentes`, `NumeroDocumento_Agentes`, `PrimerNombre_Agentes`, `SegundoNombre_Agentes`, `PrimerApellido_Agentes`, `SegundoApellido_Agentes`, `FechaNacimiento_Agentes`, `Correo_Agentes`,`Contrasena_Agentes`, `NumeroTelfono_Agentes`, `Estado_Agentes`, `FechaRegistro_Agentes`) VALUES (NULL, '1', '542375748723', 'Luis', NULL, 'Gomez', NULL, '1989-10-08', 'luis@gmail.com','1234', '338457398', 'ACTIVO', NULL);
INSERT INTO `Agentes` (`IdAgente_Agentes`, `IdTipoDocumento_Agentes`, `NumeroDocumento_Agentes`, `PrimerNombre_Agentes`, `SegundoNombre_Agentes`, `PrimerApellido_Agentes`, `SegundoApellido_Agentes`, `FechaNacimiento_Agentes`, `Correo_Agentes`,`Contrasena_Agentes`, `NumeroTelfono_Agentes`, `Estado_Agentes`, `FechaRegistro_Agentes`) VALUES (NULL, '1', '173481758732', 'Felipe', NULL, 'Gomez', NULL, '1970-01-16', 'felipe@gmail.com','1234', '3456789012', 'ACTIVO', NULL);
INSERT INTO `Agentes` (`IdAgente_Agentes`, `IdTipoDocumento_Agentes`, `NumeroDocumento_Agentes`, `PrimerNombre_Agentes`, `SegundoNombre_Agentes`, `PrimerApellido_Agentes`, `SegundoApellido_Agentes`, `FechaNacimiento_Agentes`, `Correo_Agentes`,`Contrasena_Agentes`, `NumeroTelfono_Agentes`, `Estado_Agentes`, `FechaRegistro_Agentes`) VALUES (NULL, '1', '65675475667', 'Luisa', NULL, 'Rodriguez', NULL, '1990-04-09', 'luisa@gmail.com','1234', '3210987654', 'ACTIVO', NULL);
